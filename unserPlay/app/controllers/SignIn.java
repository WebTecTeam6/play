...
public class SignIn extends Controller {
    ...
    public static Result signInValidation() {
        ...
        if (isinDB == false) {
            ...
            JOptionPane.showMessageDialog(null, "Sie Held haben sich bereits eingeschrieben");
            return ok(main.render(contentSignIn.render(firstName, lastName, age), header.render(), navigation.render("signin"), footer.render(), sidebar.render("signin")));
        ...
        return ok(main.render(contentSignIn.render(firstOut, lastOut, ageOut), header.render(), navigation.render("signin"), footer.render(), sidebar.render("signin")));
